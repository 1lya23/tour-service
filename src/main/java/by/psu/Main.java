...
import by.psu.database.JdbcHelper;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Map<TourService, Integer> services =
                    new HashMap<>();
            ...
            Excursion dbExcursion =
                    new Excursion();

            dbExcursion.setName("Paris Tour");

            dbExcursion.setPrice(
                    new BigDecimal("120")
            );

            helper.create(dbExcursion);
            ...
            System.out.println(
                ...
                TourServiceValidationException e
        ) {
